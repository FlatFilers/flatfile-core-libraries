import { IDictionary, ScalarDictionary } from './general.interface'
...
export interface ISettings {
  ...
  /**
   * [this feature is intentionally not documented or advertised]
   *  Whether or not to auto-match fields
   */
  autoMatch?: boolean
  ...
  /**
   * Prevent HoT from auto trimming
   */
...
export interface IIntegrationFont {
  family: string
  style?: any
  weight?: any
  src: {
